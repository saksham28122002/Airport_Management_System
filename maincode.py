...
import datetime
admin={"saksham":"saksham","matsa":"matsa",'admin':'admin', "ishaan":"ishaan"}
supervis={"saksham1":"saksham1","matsa1":"matsa1",'supervis':'supervis',"ishaan1":"ishaan1"}
standard={"saksham2":"saksham2","matsa2":"matsa2",'standard':'standard',"ishaan2":"ishaan2"}
...
def supmain():#supervisor control panel
    def switchusersup():
        ...
        login()
    supmainsc=tk.Tk()
    img=tk.PhotoImage(file="aerolinea.png")
